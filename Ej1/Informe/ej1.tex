...
\todo{que onda la fase, desir o hacer algo}
...
\todo{desir algo mas, ver que hago con los graficos
}
...
\todo{ver que hacer, si volarlo o no}
\subsubsection{Dc sweep}
...
Tal como se observa  en ambas figuras, se observa la saturacion del OpAmp, en los Casos 1 y 2. Esto se deve a su alta ganancias en comparacion a la tension de entrada.Para poder haver observado la saturación del caso 3, la tension de entrada deveria haver sido de  $\pm 25 v$ .
