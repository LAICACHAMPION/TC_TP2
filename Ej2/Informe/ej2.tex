...
\todo{foto de la medicion chueca}
...
Con los datos de \todo{REFERENCIA A LA TABLITA DEL ANEXO}, lo calculado con la f\'ormula \ref{eq:2tf1polo} y la simulaci\'on del circuito en \textit{LTspice}, se elaboraron los siguientes diagramas de Bode:
 
\todo{BODES SUPERPUESTOS}
...
\todo[inline]{SUPERPONER SIMULADO CON C=12PF}
...
\todo[inline]{SUPERPONER SIMULADO CON C=24PF}
...
\todo[inline]{MODELO DEL CIRCUITO QUE USO? SI ALCANZA EL TIEMPO}
...
\todo[inline]{BODE DE IMPEDANCIA DE ENTRADAAAAAAAAAA AAAAAAAAAAA}
